...
HD_PWD='C:/Users/bigbo/Desktop/AudioTone_FPGA/AudioTone_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log synth_audio_output.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source synth_audio_output.tcl -notrace
