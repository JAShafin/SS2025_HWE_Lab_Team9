...
HD_PWD='C:/Users/bigbo/Desktop/AudioTone_FPGA/AudioTone_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synth_audio_output.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synth_audio_output.tcl
